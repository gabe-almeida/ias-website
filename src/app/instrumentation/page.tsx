      ...
      <section className="section">
        <div className="wrap">
          ...
          <div className="inst-more reveal">
            ...
            Fischer moisture, dissolved gases, microbiological plate counts, capillary
            electrophoresis, HACH, TOC, BOD, liquid scintillation, full microbiological
            capabilities, and select ASTM physical methods.{" "}
