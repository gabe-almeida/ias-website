...
export const metadata: Metadata = {
  ...
  description:
    "Browse 1,000+ IAS tests with flat catalog pricing — water, soil, materials and biological matrices. Search and filter the full test catalog. Bottles and consultations included.",
